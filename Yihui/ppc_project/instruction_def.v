...
`define TLBILX_OPCD 6'b011_111
`define TLBILX_XXO	10'b00000_10010

`define TLBIVAX_OPCD 6'b011_111
`define TLBIVAX_XXO	10'b11000_10010

`define TLBRE_OPCD 	6'b011_111
`define TLBRE_XXO	10'b11101_10010

`define TLBSX_OPCD 	6'b011_111
`define TLBSX_XXO	10'b11100_10010

`define TLBSYNC_OPCD 6'b011_111
`define TLBSYNC_XXO 10'b10001_10110

`define TLBWE_OPCD 	6'b011_111
`define TLBWE_XXO	10'b11110_10010

`define DCBF_OPCD	6'b011_111
`define DCBF_XXO	10'b00010_10110

`define DCBI_OPCD	6'b011_111
`define DCBI_XXO	10'b01110_10110

`define DCBST_OPCD	6'b011_111
`define DCBST_XXO	10'b00010_10110

`define DCBT_OPCD	6'b011_111
`define DCBT_XXO	10'b01000_10110

`define DCBTST_OPCD	6'b011_111
`define DCBTST_XXO	10'b00111_10110

`define DCBZ_OPCD	6'b011_111
`define DCBZ_XXO	10'b11111_10110

`define ICBI_OPCD	6'b011_111
`define ICBI_XXO	10'b11110_10110

`define ISYNC_OPCD	6'b011_111
`define ISYNC_XXO	10'b00100_10110